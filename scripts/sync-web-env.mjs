...
const configs = {
  ...
  "xphere-testnet": {
    ...
    lines: (xphere) => [
      ...
      `VITE_XPHERE_XUSDT=${xphere.tokens.xUSDT || process.env.XPHERE_XUSDT_TOKEN || process.env.VITE_XPHERE_XUSDT || ""}`,
  ...
  "xphere-mainnet": {
    ...
    lines: (xphere, ethereum) => [
      ...
      `VITE_XPHERE_FACTORY=${xphere.contracts.factory}`,
      `VITE_XPHERE_WXP=${xphere.contracts.wXP}`,
      `VITE_XPHERE_XUSDC=${xphere.tokens.xUSDC || ""}`,
      `VITE_XPHERE_XUSDT=${xphere.tokens.xUSDT || ""}`,
      ...
      `VITE_ETHEREUM_USDC_WARP_ROUTER=${ethereum?.bridgeRoutes?.["xphere-usdc"]?.sourceRouter || process.env.VITE_ETHEREUM_USDC_WARP_ROUTER || ""}`,
      `VITE_XPHERE_USDC_WARP_ROUTER=${xphere?.bridgeRoutes?.["ethereum-usdc"]?.destinationRouter || process.env.VITE_XPHERE_USDC_WARP_ROUTER || ""}`,
      `VITE_ETHEREUM_USDT_WARP_ROUTER=${ethereum?.bridgeRoutes?.["xphere-usdt"]?.sourceRouter || process.env.VITE_ETHEREUM_USDT_WARP_ROUTER || ""}`,
      `VITE_XPHERE_USDT_WARP_ROUTER=${xphere?.bridgeRoutes?.["ethereum-usdt"]?.destinationRouter || process.env.VITE_XPHERE_USDT_WARP_ROUTER || ""}`,
      `VITE_ETHEREUM_NATIVE_WARP_ROUTER=${ethereum?.bridgeRoutes?.["xphere-native"]?.sourceRouter || process.env.VITE_ETHEREUM_NATIVE_WARP_ROUTER || ""}`,
      `VITE_XPHERE_NATIVE_WARP_ROUTER=${xphere?.bridgeRoutes?.["ethereum-native"]?.destinationRouter || process.env.VITE_XPHERE_NATIVE_WARP_ROUTER || ""}`,
    ],
  },
};
...
const lines = [
  ...
  ...config.lines(primary, secondary),
